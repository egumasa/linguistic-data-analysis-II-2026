...
These are the rule-based / feature-based tools from LDA I. We contrast the features they *quantify* (lexical diversity, syntactic complexity) with the classifications an LLM *judges in context*.

- [TAALED, TAALES, TAASSC Setup](taales-taassc.md)
- [Japanese NLP](japanese-nlp.qmd)
