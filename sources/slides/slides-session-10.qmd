...
- Which model to use? How can we use a appropriate model?
   - Use basic models
   - Follow literature
   - Try different models and report highest
   - Report all (robust)
- Stability: 
   - Stabilities 
   - Model availability & Temperature
- how do we know that our gold is gold?
