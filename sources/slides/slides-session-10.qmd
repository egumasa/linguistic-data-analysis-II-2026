...
2. **Mizumoto (2025)** — critical in-class reading
...
- **Reproducibility**: can the exact analysis be reconstructed?
- **Robustness**: does the conclusion survive reasonable changes?
- **Validity**: does the output measure the intended construct?
...
Does the conclusion survive **methods effect**?
...
::: {.callout-warning}
A reproducible result can still be **invalid**.
:::
...
# Mizumoto (2025) - Auto Error Analyzer


## Mizumoto (2025): What does the tool do?

**Input:** L2 learner writing

**LLM operations:**

1. Produce a corrected sentence
2. Compare the original and corrected versions
3. Identify error instances
4. Assign errors to 23 categories
...
- Human–tool error-count correlation: **r = .94**
- Micro-precision: **.96**
- Micro-recall: **.94**
- Micro-F1: **.95**

> How much confidence should we place in these results?

## In-class reading — 20 minutes

Focus on:

- **pp. 7–11:** tool, prompt, and error-analysis pipeline
...
- What counts as the same error for humans and the tool?
...
- Does the evaluation distinguish detection from categorization?
