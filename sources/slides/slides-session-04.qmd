...
$p_e$ = the agreement they'd hit **by luck**, using each coder's own **marginal rate** (row/column totals ÷ 50). 
...
For CEFR ($N = 6$): an **off-by-one** slip weighs $\tfrac{1}{25} = 0.04$ (barely penalized); a far-apart **A1 ↔ C2** weighs $\tfrac{25}{25} = 1.0$ (full penalty).
...
## Coming up
- **S5 — Gold-Standard Annotation & Agreement** *(hands-on)*: build the gold standard and measure agreement — executes **Phases ①–③**.
