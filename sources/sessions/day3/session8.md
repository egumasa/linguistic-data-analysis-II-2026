...
- Further reading: [Replicating Kim & Lu with open data](../../notebooks/tutorial-day3-move-replication.md) (the discourse-move mini-project track)
- Slides: [Session 8 slides](../../slides/slides-session8.html)
